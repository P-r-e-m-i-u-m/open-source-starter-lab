...
describe("Daily Issue Backlog Data", () => {
  it("should be an array containing at least one issue", () => {
  ...
  it("should have the 'daily starter issue' label on every entry", () => {
  ...
  it("should have unique titles for every issue", () => {
  ...
  it("should ensure every entry satisfies the DailyIssue shape with usable content", () => {
